...
try {
    ...
    // Get Admin Details
    $stmt = $pdo->prepare("SELECT id, first_name, last_name, email, role, status, message_disabled, booking_disabled, created_at, last_login, last_ip, avatar FROM users WHERE id = ?");
